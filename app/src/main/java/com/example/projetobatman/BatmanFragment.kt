...
import com.example.projetobatman.databinding.FragmentBatmanBinding
...
/**
 * Classe referente ao comportamento do fragment_batman
 */
class BatmanFragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        val binding = DataBindingUtil.inflate<FragmentBatmanBinding>(inflater,
